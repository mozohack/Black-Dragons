...
<div >
  ...
  <h3>Traffic and accident management</h3>
  <p><em>Black Dragons</em></p>
 
  <div class="row" style="align:'center';">
    <div class="container ">
            <form role="search" name="reg" method="POST" >
                <div class="form-group" >
                    <input type="text" class="form-control" id="numberplate"name="numberplate" value="">
                
                <button class = "glyphicon glyphicon-search" type="button" class="btn btn-default" onclick="run()">Search</button>
            </div>
