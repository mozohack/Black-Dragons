...
<div class="albums-container container-fluid">
    ...
    <div class="row">
                ...
                <div class="col-sm-4 col-lg-2">
                    <div class="thumbnail">
                        <a href="/music/1/">
                            <img src="ch.jpg" class="img-responsive" width="160" height="140">
                        </a>
                        <div class="caption">
                            <h3>Chennai</h3>
                            ...
                            <!-- View Details -->
                            <a href="sumatry.php" class="btn btn-primary btn-sm" role="button">View Details</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-4 col-lg-2">
                    <div class="thumbnail">
                        <a href="/music/1/">
                            <img src="kaa.jpg" class="img-responsive" width="160" height="140">
                        </a>
                        <div class="caption">
                            <h2>Kanchipuram</h2>
